...
import cn.cr.dao.OrderDOMapper;
import cn.cr.dao.SequenceDOMapper;
import cn.cr.dataobject.OrderDO;
import cn.cr.dataobject.SequenceDO;
...
public class OrderServiceImpl implements OrderService{
    ...
    public String generateOrderNo(){
        ...
        //最后2位为分库分表位,即同一用户id永远插入同一库中同一表，暂时写死
